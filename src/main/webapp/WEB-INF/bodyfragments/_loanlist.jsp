...
<c:url var="addUrl" value="/home/admin/loan" />

<c:url var="addSearch" value="/home/admin/loans" />

<c:url var="editUrl" value="/home/admin/loan?id=" />

<sf:form method="post"
	action="${pageContext.request.contextPath}/home/admin/loans"
	modelAttribute="form">
				...
				<tbody>
					...
					<c:forEach items="${list}" var="loan_list" varStatus="u">
						...
						<tr>
							...
							<td scope="row">${loan_list.user.firstName} ${loan_list.user.lastName}</td>
							...
							<td scope="row">${loan_list.createdDatetime}</td>
							
							<c:if test="${sessionScope.user.roleId == 1}">
								<td><a class="text-dark fw-bold btn btn-outline-primary" href="${editUrl} ${loan_list.id}"
